...
export default async function WeekendAccaPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white">Weekend Acca</h1>
        <p className="mt-1 text-sm text-zinc-500">Best picks across the week&apos;s fixtures</p>
      </div>

      {accasWithLegs.length === 0 ? (
        <div className="rounded-xl border border-zinc-800 py-20 text-center">
          <p className="text-zinc-500">No weekend acca available yet.</p>
          <p className="mt-1 text-xs text-zinc-600">Weekend accas are built every Monday at 08:00 UTC</p>
        </div>
      ) : (
